        ...
        <div className="grid grid-cols-1 gap-8 pb-12 sm:grid-cols-2 md:grid-cols-3">
          {items.map((it) => (
            ...
            >
              ...
              {/* pill label */}
              <div className="mt-3 rounded-full border border-black/30 bg-[#f6f5f2] px-8 py-2 text-[14px] font-semibold tracking-[0.18em] text-black/80 group-hover:border-black/50">
                {it.label}
              </div>
            </button>
          ))}
